        ...
        <div class="flex font-sans w-full">
            ...
            <div class="flex-auto w-full">
                    ...
                    <div class="flex p-6 bg-slate-100 items-center rounded-xl">
                        ...
                        <div class="flex-auto">
                            ...
                            <div class="flex space-x-4 mb-6 text-sm font-medium">
                                ...
                                <a href="{{ route('partner.dashboard.pengajuan.edit', $pengajuanmodal->id) }}">
                                    <button class="h-10 bg-slate-600 px-10 font-semibold rounded-md text-white"
                                        type="button">
                                        Ubah
                                    </button>
                                </a>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                    action="{{ route('partner.dashboard.pengajuan.destroy', $pengajuanmodal->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                                        class="h-10 bg-gray-500 px-10 font-semibold rounded-md text-white">Delete</button>
                                </form>

                                <a href="{{ route('partner.dashboard.pengajuan.detail', $pengajuanmodal->id) }}">
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{ route('partner.dashboard.pengajuan.add') }}">
                        <button class="h-10 bg-gray-500 px-10 font-semibold rounded-md text-white" type="button">
                            + Buat
                        </button>
                    </a>
                </div>
